...
button2 = Button(frame, text="Fluidic Acquisition", background='#3A7BB5', foreground='white', width=button_width, height=button_height)
...
# logo images
PSPath = "Software\Dashboard\planktoscope_lavender.png"
img = Image.open(PSPath)
imgResized = img.resize((button_width*5, button_height*10), Image.Resampling.LANCZOS)
...
UCTPath = "Software\Dashboard\logo.png"
imgUCT = Image.open(UCTPath)
imgUCTResized = imgUCT.resize((button_width*5, button_height*10), Image.Resampling.LANCZOS)
